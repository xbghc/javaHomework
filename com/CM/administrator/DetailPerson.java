...
import com.CM.resident.Individual;

import javax.swing.*;

public class DetailPerson extends JFrame {

    Individual individual;

    DetailPerson(String username){
        ...
        add(delete);
        add(cancel);
        alter.setBounds(50,300,100,40);
        complete.setBounds(200,300,100,40);
        delete.setBounds(350,300,100,40);
        cancel.setBounds(500,300,100,40);
        ...
        delete.addActionListener(e->{
            String sql=String.format("DELETE FROM user WHERE username='%s'",individual.username);
            DBman.update(sql);
            sql=String.format("DELETE FROM people WHERE username='%s'",individual.username);
            DBman.update(sql);
            dispose();
        });
